...
grainsize <- read.csv("/Users/boz/Desktop/Repositories/MGP_bosworth/data/grainsize.csv")

grainsize <- read.csv(here("data", "grainsize.csv"))
...
grainsize_filter <- grainsize_filter %>%
  mutate(
    popup_content = paste(
      ...
      "Lat: ", round(Lat, 6), "<br/>",
      "Long: ", round(Long, 6), "<br/>",
      "<strong>Grain Size Distribution:</strong><br/>",
      "Gravel: ", round(Gravel_pct, 1), "%<br/>",
      "Coarse Sand: ", round(CoarseSand_pct, 1), "%<br/>",
      "Medium Sand: ", round(MediumSand_pct, 1), "%<br/>",
      "Fine Sand: ", round(FineSand_pct, 1), "%<br/>",
      "Silt/Clay: ", round(SiltClay_pct, 1), "%<br/>",
      "<strong>Environmental Parameters:</strong><br/>",
      "Temperature: ", round(TempC, 2), "°C<br/>",

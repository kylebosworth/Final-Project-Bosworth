...
```
### The Mullet Gut Project




```{r include_image, echo=FALSE, out.width='70%', fig.align='center'}
knitr::include_graphics("~/Desktop/Repositories/Final Project Bosworth/MBIO612_finalproject/image.png")
